								...
								>
									{#snippet child({ props })}
										<a href={item.url} {...props}>
											...
											{:else if item.url === "/components/debounce-input"}
												<Badge
													size="sm"
													variant="emerald"
												>
