<script lang="ts">
	...
	import PackageBadges from "$lib/components/docs/base/main/package-badges.svelte";
...
<div class="space-y-6">
	<section>
		...
		<div class="mt-3 max-w-2xl">
			<Paragraph>
				Composable table filters with text, number, option, and date
				operators for Svelte apps.
			</Paragraph>
			<PackageBadges {packages} />
		</div>
	</section>

	<section class="max-w-3xl">
		<PMCommand command="add" args={[componentURL]} />
	</section>
</div>
